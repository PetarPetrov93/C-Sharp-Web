        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false, comment: "This is the genre name")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Game idenrifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "Game Pucture"),
                    PublisherId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Game's publisher identifier"),
                    ReleasedOn = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Game's release date"),
                    GenreId = table.Column<int>(type: "int", nullable: false, comment: "Game's genre identifier")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GamerId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Gamer Identifier")
                },
                constraints: table =>
                {
